                ...
                [
                    ...
                    [
                        ...
                        .OnClicked(FOnClicked::CreateUObject(
                            this, &UAocietyPauseMenuWidget::HandleResumeClicked))
                        [
                            SNew(STextBlock)
                    ...
                    [
                        ...
                        .HAlign(HAlign_Center)
                        .OnClicked(FOnClicked::CreateUObject(
                            this, &UAocietyPauseMenuWidget::HandleMainMenuClicked))
                        [
                            SNew(STextBlock)
                            .Text(FText::FromString(TEXT("返回主菜单")))
                            .Font(FCoreStyle::GetDefaultFontStyle(TEXT("Regular"), 19))
                        ]
                    ]
                    + SVerticalBox::Slot()
                    ...
                    [
                        ...
                        .HAlign(HAlign_Center)
                        .OnClicked(FOnClicked::CreateUObject(
                            this, &UAocietyPauseMenuWidget::HandleQuitClicked))
                        [
                            SNew(STextBlock)
...
FReply UAocietyPauseMenuWidget::HandleMainMenuClicked()
{
    ...
    UGameplayStatics::OpenLevel(
        ...
        true,
        TEXT("game=/Script/Aociety.AocietyMainMenuGameMode"));
    return FReply::Handled();
}
