...
SOURCE = Path(
    r"C:\Users\jingk\AppData\Local\Temp\codex-clipboard-f50c212d-3644-4fe9-91a5-fc398dfbedf8.png"
)
OUTPUT = Path(r"E:\Aociety-NEW\SourceAssets\UI\speech_bubble_ivory.png")
